...
class OrderAPIView(views.APIView):
    ...
    def get(self, request):
        try:
            ...
            return custom_response(
                "Get all categories successfully!", "Success", serializers.data, 200
            )
        except:
    ...
    def post(self, request):
        try:
            ...
            return custom_response(
                "Create order successfully!", "Success", serializer.data, 201
            )
...
class OrderDetailAPIView(views.APIView):
    ...
    def get(self, request, id_slug):
        try:
            ...
            return custom_response(
                "Get all order details successfully!", "Success", serializers.data, 200
            )
        except:
    ...
    def put(self, request, id_slug):
        try:
            ...
            if serializer.is_valid():
                serializer.save()
                return custom_response(
                    "Update order successfully!", "Success", serializer.data, 200
                )
            else:
                return custom_response(
                    "Update order failed", "Error", serializer.errors, 400
                )
        except:
            return custom_response(
                "Update order failed", "Error", "Order not found!", 400
            )
    ...
    def delete(self, request, id_slug):
        try:
            ...
            order.delete()
            return custom_response(
                "Delete order successfully!", "Success", {"order_id": id_slug}, 204
            )
        except:
            return custom_response(
                "Delete order failed!", "Error", "Order not found!", 400
            )
...
class OrderDetailWithProductAPIView(views.APIView):
    ...
    def get(self, request, order_id_slug):
        try:
            ...
            return custom_response(
                "Get all order detail successfully!", "Success", serializers.data, 200
            )
        except:
    ...
    def post(self, request, order_id_slug):
        try:
            ...
            return custom_response(
                "Create order detail successfully!", "Success", serializer.data, 201
            )
        except Exception as e:
            return custom_response(
                "Create order detail failed!", "Error", [str(e)], 400
            )
...
class OrderDetailWithProductDetailAPIView(views.APIView):
    ...
    def get(self, request, order_id_slug, id_slug):
        try:
            ...
            serializer = OrderDetailSerializer(order_detail)
            return custom_response(
                "Get order detail successfully!", "Success", serializer.data, 200
            )
        except:
    ...
    def put(self, request, order_id_slug, id_slug):
        try:
            ...
            if serializer.is_valid():
                serializer.save
                return custom_response(
                    "Update order detail successfully!", "Success", serializer.data, 200
                )
            else:
                return custom_response(
                    "Update order detail failed!", "Errors", serializer.errors, 400
                )

        except:
            return custom_response(
                "Update order detail failed", "Error", "Order detail not found!", 400
            )
            ...
            def delete(self, request, order_id_slug, id_slug):
                try:
                    ...
                    order_detail.delete()
                    return custom_response(
                        "Delete order detail successfully!",
                        "Success",
                        {"order_detail_id": id_slug},
                        204,
                    )
                except:
                    return custom_response(
